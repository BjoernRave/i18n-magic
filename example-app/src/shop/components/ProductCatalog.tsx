  ...
  return (
    <div className="shop-catalog">
      <div className="catalog-header">
        <h1>{t('shop.catalog.title')}</h1>
        <p>{t('shop.catalog.subtitle', { count: filteredProducts.length })}</p>
      </div>
            ...
            <div className="product-info">
              ...
              <div className="product-rating">
                ...
                <span className="rating-text">
                  {product.rating} ({t('shop.catalog.reviews', { count: product.reviewCount })})
                </span>
              </div>
                ...
                {product.isOnSale && (
                  <span className="discount">
                    {t('shop.catalog.saveAmount', { 
                      amount: formatPrice((product.originalPrice || 0) - product.price)
                    })}
                  </span>
                )}
              </div>
